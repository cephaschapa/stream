    ...
    return (
        <div>
            ...
            <Menu open={open}>
                ...
                }} className="border-none  flex items-center w-full space-x-2 justify-center text-gray-6 font-bold p-4 uppercase rounded-2xl absolute m-1">
                  
                    {
                      theme=== 'dark'? <p className="dark:text-white">Light Mode</p>: <p className="dark:text-white">Dark Mode</p>
                    }
                  
                    {
                      theme === 'dark'? <SunIcon className="h-6 w-6 text-white"/> : <MoonIcon className="h-6 w-6 text-slate-500"/>
                    }            
                </button>
                </MenuContainer>
            </Menu>
